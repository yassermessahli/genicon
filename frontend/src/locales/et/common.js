...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Genicon töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      title: "Tere tulemast Genicon-i",
      description:
        "Aita meil Genicon sinu vajadustele vastavaks kujundada. Valikuline.",
      email: "Mis on su e-post?",
      useCase: "Milleks kasutad Genicon-i?",
      useCaseWork: "Töö jaoks",
      useCasePersonal: "Isiklikuks kasutuseks",
      useCaseOther: "Muu",
      comment: "Kust kuulsid Genicon-ist?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Loo esimene tööruum ja alusta Genicon-iga.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Tere tulemast Genicon-i! See on Mintplex Labsi avatud lähtekoodiga AI-tööriist, mis muudab kõik failid koolitatud juturobotiks, kellega saad vestelda. Genicon on BYOK-tarkvara, seega puudub igasugune tellimus- või litsentsitasu, välja arvatud kasutatavate teenuste kulud.",
    part2:
      "Genicon on lihtsaim viis kombineerida võimsad AI-teenused nagu OpenAI, GPT-4, LangChain, PineconeDB, ChromaDB jpt ilma vaevata, tõstes sinu produktiivsust kordades.",
    part3:
      "Genicon võib töötada täielikult lokaalselt sinu masinas minimaalse ressursikasutusega – GPU-d pole vaja. Samuti on saadaval pilve- ja kohapealsed paigaldised.\nAI-ökosüsteem muutub iga päevaga võimekamaks ja Genicon teeb selle kasutamise lihtsaks.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Oled teel Genicon-i eksperdiks saama!",
      dismiss: "sulge",
      tasks: {
        create_workspace: {
          title: "Loo tööruum",
  ...
  customization: {
    interface: {
      ...
      description: "Sea Genicon-i UI eelistused.",
    },
    branding: {
      title: "Bränding ja valgesildistamine",
      description: "Valgesildista oma Genicon kohandatud brändinguga.",
    },
    chat: {
      title: "Vestlus",
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles Genicon UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda Genicon instantsi.",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul Genicon ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et Genicon saaks sinu failid ja päringud töödelda.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas Genicon töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Konfiguratsioon kolmandate osapoolte ja Genicon-i andmekäitluse kohta.",
    llm: "LLM-i valik",
