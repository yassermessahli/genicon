...
const TRANSLATIONS = {
  ...
  settings: {
    ...
    "system-prompt-variables": "متغيرات موجه النظام",
    interface: "تفضيلات الواجهة",
    branding: "العلامة التجارية والوسم الأبيض",
    chat: "الدردشة",
    preferences: "التفضيلات",
    "chat-settings": "إعدادات الدردشة",
    "agents-settings": "إعدادات الوكلاء",
  ...
  security: {
    ...
    multiuser: {
      ...
      enable: {
        ...
        username: "اسم المستعمِل لحساب المشرف",
