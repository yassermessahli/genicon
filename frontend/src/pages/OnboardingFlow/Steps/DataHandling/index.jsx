...
import GeniconIcon from "@/media/logo/genicon-icon.png";
...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of Genicon",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "Genicon Embedder",
    description: [
      "Your document text is embedded privately on this instance of Genicon",
    ],
    logo: GeniconIcon,
  },
  openai: {
...
export const FALLBACKS = {
  LLM: (provider) => ({
    name: "Unknown",
    description: [
      `"${provider}" has no known data handling policy defined in Genicon`,
    ],
    logo: GeniconIcon,
  }),
  EMBEDDING: (provider) => ({
