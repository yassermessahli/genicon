...
<p align="center">
<b>Genicon:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">  
👉 Masaüstü için Genicon (Mac, Windows ve Linux)! <a href="https://anythingllm.com/download" target="_blank"> Şimdi İndir</a>  
</p>
...
Mintplex Labs ve topluluk, Genicon'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında Genicon kurun →](../BARE_METAL.md)
...
_Bu uygulamalar Mintplex Labs tarafından yönetilmemektedir, ancak Genicon ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._
...
- [Coolify](https://coolify.io/docs/services/anythingllm/) - Tek tıklamayla Genicon dağıtımı yapmanıza olanak tanır.
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - Genicon’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik

Mintplex Labs Inc. tarafından geliştirilen Genicon, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.

<details>  
<summary><kbd>Genicon için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>

### Neden?

Bu bilgileri, Genicon’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.
