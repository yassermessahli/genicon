...
/**
 * An interface to the Genicon Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the Genicon instance.
  ...
  /**
   * Apply an item to the Genicon instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the Genicon instance by downloading the zip file and importing it.
